...
void HariMain(void)
{
	...
	*((int *) 0x0fe4) = (int) shtctl;
	...
	sheet_setbuf(sht_naomi, buf_naomi, 28, 26, COL8_008484);	/* 透明色あり */
	...
	sheet_setbuf(sht_balloon, buf_balloon, 120, 28, COL8_008484);	/* 透明色あり */
	...
	sht_balloon->flags |= 0x100;	/* OSAkkie特殊ウィンドウ */
	...
	init_mouse_cursor8(buf_mouse, 99/* 背景色 */);
...
struct SHEET *open_console(struct SHTCTL *shtctl, unsigned int memtotal)
{
	...
	make_window8(buf, 256, 165, "Console", 0/* ナオミさん */, 0);
